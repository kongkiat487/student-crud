...
<head>
    ...
    <title>ระบบจัดการข้อมูลนักศึกษา (Student CRUD)</title>
    <!-- Bootstrap 5 CSS CDN -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">
                <i class="bi bi-person-lines-fill me-2"></i>ระบบจัดการนักศึกษา
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="create.php">เพิ่มนักศึกษาใหม่</a>
                    </li>
                </ul>
            </div>
        </div>
